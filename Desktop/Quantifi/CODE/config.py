...
PARAMS = {
    ...
    'slippage': 0.5/100,
    'max_MC_rank': 30, ##We only consider coins ranked until this MC rank in our investment universe at all times
    'min_volume_thres': 5_000_000, #We only consider coins with this minimum 24-hour trading volume in the investment universe
    'sma_window': 20,
    'vol_window': 7, #Window used as a lookback for volatility targeting
    'vol_target': 0.7, #Annualized volatility targeted by the portfolio
    ...
    'regime_filter': False, #Momentum regime filter based on Bitcoin momentum. 
    'rebalancing': False,
    'rsi_window': 4,
    'min_rsi': 95,
    'ranking_method': 'momentum', #mean_deviation
    'lookback_window': 90,
    'n_coins': None,
    'perf_thres': None,
    'long_regime_window': 100,
    'short_regime_window': 10,
